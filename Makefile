...
client: $(SRC_DIR)dropboxClient.c utilities
	$(CC) -o $(BIN_DIR)dropboxClient $(SRC_DIR)dropboxClient.c $(BIN_DIR)dropboxUtil.o $(FLAGS)

server: $(SRC_DIR)dropboxServer.c utilities
	$(CC) -o $(BIN_DIR)dropboxServer $(SRC_DIR)dropboxServer.c $(BIN_DIR)dropboxUtil.o $(FLAGS)
